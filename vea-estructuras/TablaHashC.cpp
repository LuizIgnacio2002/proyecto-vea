...
template <typename T>
unsigned long long TablaHashC<T>::ConvertirCaracterEntero(char entrada)
{
    return 0;
}

template <typename T>
unsigned long long TablaHashC<T>::ObtenerNumero(std::string entrada)
{
    return 0;
}

template <typename T>
int TablaHashC<T>::FuncionHash(std::string entrada, int intento)
{
    return 0;
}

template <typename T>
TablaHashC<T>::TablaHashC()
{
}

template <typename T>
void TablaHashC<T>::insertarClave(std::string clave)
{
}

template <typename T>
void TablaHashC<T>::verElementos() const
{
}
